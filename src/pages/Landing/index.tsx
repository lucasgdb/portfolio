					...
					{showMore && (
						<>
							...
							<Certificate
								...
								url="https://certificates.balta.io/NWVlODMyZTU2NjY2NTgxYmRjYjYwNzkzLDVjNmIyY2MyZTcxNzlhMjdlYjYyYmFlMA=="
							>
								Mini Curso de Gestão de Dados feito na Fatec
								Guaratinguetá - SETI 2019
							</Certificate>
							...
							>
								Curso básico de PHP do Curso em Vídeo (Gustavo
								Guanabara)
							</Certificate>
							...
							>
								Curso de PWA (Progressive Web Apps) feito na SETI 2018
								da ETEC.
							</Certificate>
							...
							>
								Curso de Algoritmo do Curso em Vídeo utilizando Java
								como linguagem.
							</Certificate>
